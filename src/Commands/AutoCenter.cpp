...
const int COMBINED_NUMBER = 58; // Inches, too. 58 is the sum of a few numbers, it is the distance from the outer edge of the barrier to the switch.
...
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	std::string goalPositions = frc::DriverStation::GetInstance().GetGameSpecificMessage();
		if(goalPositions[0] == 'R'){
			...
			AddSequential(new AutoDrive(ROBOT_PLACEMENT - COMBINED_NUMBER, true, 3)); // line up the robot with the side edge of the switch
