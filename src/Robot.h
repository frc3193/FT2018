...
#include "Commands/AutoTimedStraight.h"

#include "OI.h"

class Robot : public frc::TimedRobot {
public:
	std::unique_ptr<Command> autonomousCommand = nullptr;
	...
	static std::shared_ptr<Pressurizer> pressurizer;
	static std::shared_ptr<Ramp> ramp;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
	static Preferences* robotPref;
